        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DependencyTaskId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskDependencies_Tasks_DependencyTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskDependencies_DependentTaskId_DependencyTaskId",
                table: "TaskDependencies",
                columns: new[] { "DependentTaskId", "DependencyTaskId" },
                unique: true);
        }
